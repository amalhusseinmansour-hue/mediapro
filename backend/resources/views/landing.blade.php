...
<body>
    ...
    <footer class="footer">
        ...
        <div class="container" style="text-align: center; padding-bottom: 3rem; border-bottom: 1px solid rgba(148, 163, 184, 0.1); margin-bottom: 3rem;">
            <h3 style="font-size: 2rem; margin-bottom: 1rem; background: linear-gradient(135deg, #e2e8f0 0%, #cbd5e1 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                <i class="fas fa-mobile-screen-button"></i> جرب التطبيق الآن
            </h3>
            <p style="color: #94a3b8; margin-bottom: 2rem; font-size: 1.1rem;">
                استمتع بتجربة كاملة على الويب مع جميع ميزات التطبيق
            </p>
            <a href="https://mediaprosocial.io/webapp/" target="_blank" class="btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem; display: inline-block;">
                <i class="fas fa-rocket"></i> افتح التطبيق
            </a>
        </div>
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="/about">من نحن</a></li>
                    <li><a href="/pricing">الأسعار</a></li>
                    <li><a href="https://mediaprosocial.io/webapp/" target="_blank"><i class="fas fa-mobile-screen-button"></i> افتح التطبيق</a></li>
                    <li><a href="/contact">اتصل بنا</a></li>
                </ul>
            </div>
