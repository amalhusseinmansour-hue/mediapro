...
class SocialMediaPostController extends Controller
{
    ...
    /**
     * Get scheduled posts for authenticated user
     */
    public function scheduledPosts(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed to fetch scheduled posts: ' . $e->getMessage(),
            ], 500);
        }
    }
     ...
     */
    public function cancelScheduledPost(string $postId): JsonResponse
    {
        try {
